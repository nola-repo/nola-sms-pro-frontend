...
export const Subaccounts = () => {
  ...
  return (
    ...
    >
      ...
      {!agencyId && (
        <div className="bg-[#f59e0b]/[0.05] border border-[#f59e0b]/30 rounded-xl p-4 mb-5 shadow-sm">
          <div className="flex items-center gap-2 text-[#f59e0b]">
            <FiAlertTriangle className="w-[18px] h-[18px]" />
            <strong className="text-[13px]">Agency ID not configured.</strong>
          </div>
          <p className="text-[12.5px] mt-2 text-[#6e6e73] dark:text-[#94959b]">
            Set <code className="bg-black/5 dark:bg-white/10 px-1 py-0.5 rounded font-mono text-[11px]">VITE_AGENCY_ID</code> in <code className="bg-black/5 dark:bg-white/10 px-1 py-0.5 rounded font-mono text-[11px]">agency/.env</code> or append <code className="bg-black/5 dark:bg-white/10 px-1 py-0.5 rounded font-mono text-[11px]">?agency_id=YOUR_ID</code> to the URL.
          </p>
        </div>
      )}
